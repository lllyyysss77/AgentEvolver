    ...
    def execute(
        ...
        **kwargs,
        ...
        try:
            ...
            # FIXME
            step[-1]["content"] = f"User may ask question like {state_message[-1]['content']}. You may explore related information, but do not simply try to answer the question. Now do your exploration!"
